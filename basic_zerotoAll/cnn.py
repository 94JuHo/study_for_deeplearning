...
%matplotlib inline #jupyter notebook 상에서 그림을 표현하기 위한 코드, 일반 python 이용시 plt.show()
...
for k in range(row_num*col_num): #시간복잡도를 줄이기 위한 방법
    i = k//col_num
    j = k%col_num
...
class CNNClassifier(nn.Module):
    ...
    def __init__(self):
        ...
        conv1 = nn.Conv2d(1, 6, 5, 1) # 6@24*24 #입력채널 수(1), 출력채널수(6), 필터크기(5)
        # activation ReLU
        pool1 = nn.MaxPool2d(2) # 6@12*12 #polling window size 2x2
